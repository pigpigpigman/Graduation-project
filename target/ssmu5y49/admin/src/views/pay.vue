<template>
  <div class="container"  :style='{"margin":"0 200px 20px"}'>
    <el-alert title="确认支付前请先核对订单 information" type="success" :closable="false"></el-alert>
    <!-- <div class="top-content">
      <span>收款人</span>
      <el-input style="width:300px" v-model="name" placeholder="收款人"></el-input>
      <span style="margin-left:20px">收款Account number</span>
      <el-input style="width:300px" v-model="account" placeholder="收款Account number"></el-input>
    </div> -->
...
export default {
  ...
  methods: {
    submitTap() {
      // if (!this.name) {
      //   this.$message.error("Please enter收款人 name");
      //   return;
      // }
      // if (!this.account) {
      //   this.$message.error("Please enter收款人Account number");
      //   return;
      // }
      if (!this.type) {
        this.$message.error("Please select支付方式");
        return;
      }
