    ...
    <div v-if="!showFlag" style="width: 100%;">
      <div>
        <el-table
          ...
          style="width: 100%;"
        >
          <el-table-column :resizable='true' :sortable='true' prop="ask" :formatter="askFormat" header-align="center" align="center" sortable label="New information"></el-table-column>
          <el-table-column
