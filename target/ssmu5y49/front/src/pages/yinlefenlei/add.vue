    ...
    >
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px 0"}' label="Music classification" prop="yinlefenlei">
            <el-input v-model="ruleForm.yinlefenlei" 
                placeholder="Music classification" clearable ></el-input>
          </el-form-item>
...
<script>
  export default {
    ...
    // 多级联动参数
      // 多级联动参数
      info(id) {
        this.$http.get('yinlefenlei/detail/${id}', {emulateJSON: true}).then(res => {
          if (res.data.code == 0) {
                  ...
                  params: params
                     ...
                     if(res.data.data.total>=crossoptnum) {
                         ...
                         // 跨表计算
                          ...
                          this.$http.post('yinlefenlei/add', this.ruleForm).then(res => {
                              if (res.data.code == 0) {
                                  this.$message({
