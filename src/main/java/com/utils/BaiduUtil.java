...
public class BaiduUtil {
    ...
    /**
	     * 获取API访问token
	     * 该token有一定的有效期，需要自行 MGT，当失效时需重新获取.
    ...
    /**
     * 识别 picture上的文本content，转成文字字符串return
     * @param imagePath  picture文件的路径
     */
    public static String generalString(String imagePath, boolean isNewline){
        try{
            ...
            options.put("detect_language", "true"); //是否检测Language，默认不检测。
