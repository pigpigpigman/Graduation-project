		...
		<el-scrollbar wrap-class="scrollbar-wrapper">
			<el-menu :default-openeds="[]" :unique-opened="true" :style='{"border":0,"padding":"0 0 100px","listStyle":"none","margin":"60px 5px 15px","overflow":"hidden","background":"#FFF","position":"relative"}' class="el-menu-vertical-demo" default-active="0">
				...
				<!-- <el-menu-item index="0" @click="menuHandler('')">
					...
					<span :style='{"color":"inherit","verticalAlign":"middle","fontSize":"14px"}'>System home page</span>
				</el-menu-item> -->
				...
				<el-submenu index="1">
					<template slot="title">
						...
						<span :style='{"color":"inherit","verticalAlign":"middle","fontSize":"14px"}'>Individual center</span>
					</template>
					<el-menu-item index="1-1" @click="menuHandler('updatePassword')">Change password</el-menu-item>
					<el-menu-item index="1-2" @click="menuHandler('center')">Personal INFO</el-menu-item>
				</el-submenu>
