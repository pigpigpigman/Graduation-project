<template>
	<div class="navbar">
		...
		<div class="right" :style='{"position":"absolute","right":"20px","top":"8px","display":"flex"}'>
			...
			<div :style='{"cursor":"pointer","margin":"0 25px","lineHeight":"44px","color":"#666"}' v-if="this.$storage.get('role')!='Administrator '" class="logout" @click="onIndexTap">quit front</div>
			<div :style='{"cursor":"pointer","margin":"0 15px","lineHeight":"44px","color":"#666"}' class="logout" @click="onLogout">quit Login</div>
		</div>
	</div>
</template>
