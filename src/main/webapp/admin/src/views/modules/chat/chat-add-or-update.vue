  ...
  <div :style='{"padding":"30px 0 0 0"}'>
    ...
    >
      ...
      <el-form-item :style='{"padding":"0","margin":"0"}'>
        ...
        <el-button :style='{"border":"1px solid rgba(27, 167, 166, 1)","cursor":"pointer","padding":"0","margin":"0","outline":"none","color":"rgba(27, 167, 166, 1)","borderRadius":"40px","background":"rgba(255, 255, 255, 1)","width":"128px","lineHeight":"40px","fontSize":"14px","height":"40px"}' @click="back()">return</el-button>
      </el-form-item>
    </el-form>
  </div>
</template>
...
export default {
  data() {
    return {
      ...
      rules: {
        reply: [
          { required: true, message: "Reply content Cannot be empty", trigger: "blur" }
        ]
      },
      inter:null
    };
