<template>
	<div class="addEdit-block" :style='{"padding":"30px 0 0 0"}' style="width: 100%;">
		...
		>
			<template >
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0","display":"inline-block"}' class="input" v-if="type!='info'"  label=" name" prop="name">
					<el-input v-model="ruleForm.name" placeholder=" name" clearable  :readonly="ro.name"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0","display":"inline-block"}' v-else class="input" label=" name" prop="name">
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0","display":"inline-block"}' class="input" v-if="type!='info'"  label=" Recommended类型" prop="inteltype">
					<el-input v-model="ruleForm.inteltype" placeholder=" Recommended类型" clearable  :readonly="ro.inteltype"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0","display":"inline-block"}' v-else class="input" label=" Recommended类型" prop="inteltype">
					<el-input v-model="ruleForm.inteltype" placeholder=" Recommended类型" readonly></el-input>
				</el-form-item>
