<template>
	<div class="addEdit-block" :style='{"padding":"30px 0 0 0"}' style="width: 100%;">
		...
		>
			<template >
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0","display":"inline-block"}' class="input" v-if="type!='info'"  label="mv name" prop="mvmingcheng">
					<el-input v-model="ruleForm.mvmingcheng" placeholder="mv name" clearable  :readonly="ro.mvmingcheng"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0","display":"inline-block"}' v-else class="input" label="mv name" prop="mvmingcheng">
					<el-input v-model="ruleForm.mvmingcheng" placeholder="mv name" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0","display":"inline-block"}' class="select" v-if="type!='info'"  label="Singer name" prop="geshouxingming">
					<el-select :disabled="ro.geshouxingming" v-model="ruleForm.geshouxingming" placeholder="Please selectSinger name" >
						<el-option
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0","display":"inline-block"}' v-else class="input" label="Singer name" prop="geshouxingming">
					<el-input v-model="ruleForm.geshouxingming"
						placeholder="Singer name" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0","display":"inline-block"}' class="upload" v-if="type!='info'&& !ro.shipin" label="video" prop="shipin">
					<file-upload
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0","display":"inline-block"}' v-else-if="ruleForm.shipin" label="video" prop="shipin">
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0","display":"inline-block"}' class="date" v-if="type!='info'" label="Release date" prop="faburiqi">
					<el-date-picker
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0","display":"inline-block"}' class="input" v-else-if="ruleForm.faburiqi" label="Release date" prop="faburiqi">
					<el-input v-model="ruleForm.faburiqi" placeholder="Release date" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0","display":"inline-block"}' class="upload" v-if="type!='info' && !ro.fengmiantupian" label="cover picture" prop="fengmiantupian">
					<file-upload
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0","display":"inline-block"}' class="upload" v-else-if="ruleForm.fengmiantupian" label="cover picture" prop="fengmiantupian">
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0","display":"inline-block"}' v-if="type!='info'"  label="lyric details" prop="gecixiangqing">
					<editor 
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0","display":"inline-block"}' v-else-if="ruleForm.gecixiangqing" label="lyric details" prop="gecixiangqing">
                    <span :style='{"fontSize":"14px","lineHeight":"40px","color":"#333","fontWeight":"500","display":"inline-block"}' v-html="ruleForm.gecixiangqing"></span>
                </el-form-item>
...
export default {
    ...
    info(id) {
      this.$http({
        ...
        this.ruleForm.gecixiangqing = this.ruleForm.gecixiangqing.replace(reg,'../../../ssmu5y49/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `yinlemv/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.yinlemvCrossAddOrUpdateFlag = false;
						 this.parent.search();
