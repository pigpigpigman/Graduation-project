<template>
	<div class="addEdit-block" :style='{"padding":"30px 0 0 0"}' style="width: 100%;">
		...
		>
			<template >
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0","display":"inline-block"}' class="input" v-if="type!='info'"  label="Music classification" prop="yinlefenlei">
					<el-input v-model="ruleForm.yinlefenlei" placeholder="Music classification" clearable  :readonly="ro.yinlefenlei"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0","display":"inline-block"}' v-else class="input" label="Music classification" prop="yinlefenlei">
					<el-input v-model="ruleForm.yinlefenlei" placeholder="Music classification" readonly></el-input>
				</el-form-item>
			</template>
