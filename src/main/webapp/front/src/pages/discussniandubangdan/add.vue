...
<div :style='{"width":"100%","padding":"20px 7% 40px","margin":"0px auto","position":"relative","background":"none"}'>
    <el-form
      ...
      label-width="110px"
    >
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px 0"}' label="avatar" v-if="type!='cross' || (type=='cross' && !ro.avatarurl)" prop="avatarurl">
            <file-upload
            ...
            <el-form-item :style='{"padding":"10px","margin":"0 0 10px 0"}' class="upload" v-else label="avatar" prop="avatarurl">
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px 0"}' label=" user name" prop="nickname">
            <el-input v-model="ruleForm.nickname" 
                placeholder=" user name" clearable ></el-input>
          </el-form-item>
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px 0"}' label="Comment content" prop="content">
            <el-input
              type="textarea"
              :rows="8"
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px 0"}' label="Reply content" prop="reply">
            <el-input
              type="textarea"
              :rows="8"
...
<script>
  export default {
    ...
    // 多级联动参数
      // 多级联动参数
      info(id) {
        this.$http.get('discussniandubangdan/detail/${id}', {emulateJSON: true}).then(res => {
          if (res.data.code == 0) {
        ...
        this.$refs["ruleForm"].validate(valid => {
          if(valid) {
            ...
            if(crossrefid && crossuserid) {
                 ...
                 this.$http.get('discussniandubangdan/list', {
                  params: params
                 }).then(res => {
                     if(res.data.data.total>=crossoptnum) {
                         ...
                         // 跨表计算
                          ...
                          this.$http.post('discussniandubangdan/add', this.ruleForm).then(res => {
                              if (res.data.code == 0) {
                                  this.$message({
