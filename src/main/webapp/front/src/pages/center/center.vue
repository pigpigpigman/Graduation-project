...
<div class="center-preview" :style='{"width":"100%","margin":"0px auto","position":"relative"}'>
    ...
    <el-tabs tab-position="left" :style='{"width":"100%","flexWrap":"wrap","justifyContent":"center","display":"flex"}' @tab-click="handleClick">
      <el-tab-pane label="Individual center">
        <el-form class="center-preview-pv" ref="sessionForm" :model="sessionForm" :rules="rules" label-width="110px">
          <el-form-item :style='{"width":"45%","padding":"10px","margin":"0 0 10px","display":"inline-block"}' v-if="userTableName=='yonghu'" label=" user Account number" prop="yonghuzhanghao">
            <el-input v-model="sessionForm.yonghuzhanghao" placeholder=" user Account number" readonly></el-input>
          </el-form-item>
          <el-form-item :style='{"width":"45%","padding":"10px","margin":"0 0 10px","display":"inline-block"}' v-if="userTableName=='yonghu'" label="password" prop="mima">
            <el-input type="password" v-model="sessionForm.mima" placeholder="password"></el-input>
          </el-form-item>
          <el-form-item :style='{"width":"45%","padding":"10px","margin":"0 0 10px","display":"inline-block"}' v-if="userTableName=='yonghu'" label=" user  name" prop="yonghuxingming">
            <el-input v-model="sessionForm.yonghuxingming" placeholder=" user  name" ></el-input>
          </el-form-item>
          <el-form-item :style='{"width":"45%","padding":"10px","margin":"0 0 10px","display":"inline-block"}' v-if="userTableName=='yonghu'" label="sex">
            <el-select v-model="sessionForm.xingbie" placeholder="Please selectsex" >
              <el-option v-for="(item, index) in dynamicProp.xingbie" :key="index" :label="item" :value="item"></el-option>
            </el-select>
          </el-form-item>
          <el-form-item :style='{"width":"45%","padding":"10px","margin":"0 0 10px","display":"inline-block"}' v-if="userTableName=='yonghu'" label="age" prop="nianling">
            <el-input v-model="sessionForm.nianling" placeholder="age" ></el-input>
          </el-form-item>
          <el-form-item :style='{"width":"45%","padding":"10px","margin":"0 0 10px","display":"inline-block"}' v-if="userTableName=='yonghu'" label="mailbox" prop="youxiang">
            <el-input v-model="sessionForm.youxiang" placeholder="mailbox" ></el-input>
          </el-form-item>
          <el-form-item :style='{"width":"45%","padding":"10px","margin":"0 0 10px","display":"inline-block"}' v-if="userTableName=='yonghu'" label="Mobile phone number" prop="shoujihao">
            <el-input v-model="sessionForm.shoujihao" placeholder="Mobile phone number" ></el-input>
          </el-form-item>
          <el-form-item :style='{"width":"45%","padding":"10px","margin":"0 0 10px","display":"inline-block"}' v-if="userTableName=='yonghu'" label="avatar">
            <el-upload
          ...
          <el-form-item :style='{"padding":"0","textAlign":"center","margin":"0"}'>
            <el-button :style='{"border":"1px solid #ccc","cursor":"pointer","padding":"0","margin":"0 20px 0 0","outline":"none","color":"rgba(255, 255, 255, 1)","borderRadius":"4px","background":"#333","width":"128px","lineHeight":"40px","fontSize":"14px","height":"40px"}' type="primary" @click="onSubmit('sessionForm')">Renewal information</el-button>
            <el-button :style='{"border":"1px solid #ccc","cursor":"pointer","padding":"0","margin":"0","outline":"none","color":"#333","borderRadius":"4px","background":"rgba(255, 255, 255, 1)","width":"128px","lineHeight":"40px","fontSize":"14px","height":"40px"}' type="danger" @click="logout">quit Login</el-button>
          </el-form-item>
        </el-form>
		
        <el-dialog title=" user 充值" :visible.sync="dialogFormVisibleMoney" width="726px" center>
      ...
      <el-tab-pane label="my Collect"></el-tab-pane>
    </el-tabs>
</div>
</template>
...
<script>
  ...
  export default {
    ...
    created() {
      ...
      if ('yonghu' == this.userTableName) {
        this.$set(this.rules, 'yonghuzhanghao', [{ required: true, message: 'Please enter user Account number', trigger: 'blur' }]);
      }
      if ('yonghu' == this.userTableName) {
        this.$set(this.rules, 'mima', [{ required: true, message: 'Please enterpassword', trigger: 'blur' }]);
      }
			if ('yonghu' == this.userTableName) {
